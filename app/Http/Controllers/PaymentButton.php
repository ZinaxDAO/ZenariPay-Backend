...
class PaymentButton extends Controller
{
    /**
    ...
    {
        try {
            $links = ModelsPaymentLinkButton::where('user_id', auth('sanctum')->id())->get();
            return response()->json(result($links));
        } catch (\Throwable $th) {
    ...
    public function store(Request $request)
    {
        try{
            ...
            ModelsPaymentLinkButton::create([
